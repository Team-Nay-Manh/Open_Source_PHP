    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="main__title">
          ...
          <a href="country.html" class="main__title-link">Thêm mới</a>
        </div>
      </div>
      <!-- end main title -->
      <!-- users -->
                ...
                <tr>
                  ...
                  <td>
                    <div class="main__table-btns">
                      <a href="country.html?id=<?php echo $v['id']; ?>" class="main__table-btn main__table-btn--edit">
...
<div id="modal-delete" class="zoom-anim-dialog mfp-hide modal">
  ...
  <div class="modal__btns">
    <button class="modal__btn modal__btn--apply" type="button" onclick="deleteItem('country.html?delete_id=' + item_id, 'countries.html')">Xoá</button>
