    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="main__title">
          ...
          <a href="film.html" class="main__title-link">Thêm mới</a>
        </div>
      </div>
      <!-- end main title -->
      <!-- users -->
      <div class="col-12">
        <div class="main__table-wrap">
          <table class="main__table">
            ...
            <tbody>
              <?php foreach ($film->GetFilms() as $k => $v) { ?>
                <tr>
                  <td>
                  ...
                  <td>
                    <div class="main__table-text"><?php echo $v['opening_day']; ?></div>
                  </td>
                  <td>
                    <div class="main__table-text"><?php echo $v['duration']; ?></div>
                  </td>
                  <td>
                    <div class="main__table-text"><?php echo $v['country_name']; ?></div>
                  </td>
                  <td>
                    <div class="main__table-text"><?php echo $v['rated_name']; ?></div>
                  </td>
                  <td>
                    <div class="main__table-btns">
                      <a href="schedule.html?film_id=<?php echo $v['id']; ?>" class="main__table-btn main__table-btn--banned" title="Thêm lịch chiếu phim này">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                          <g transform="matrix(0.43 0 0 0.43 12 12)">
                            <path transform=" translate(-25, -25)" d="M 25 2 C 12.309295 2 2 12.309295 2 25 C 2 37.690705 12.309295 48 25 48 C 37.690705 48 48 37.690705 48 25 C 48 12.309295 37.690705 2 25 2 z M 25 4 C 36.609824 4 46 13.390176 46 25 C 46 36.609824 36.609824 46 25 46 C 13.390176 46 4 36.609824 4 25 C 4 13.390176 13.390176 4 25 4 z M 24 13 L 24 24 L 13 24 L 13 26 L 24 26 L 24 37 L 26 37 L 26 26 L 37 26 L 37 24 L 26 24 L 26 13 L 24 13 z" stroke-linecap="round" />
                          </g>
                        </svg>
                      </a>
                      <a href="film.html?id=<?php echo $v['id']; ?>" class="main__table-btn main__table-btn--edit">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
<div id="modal-delete" class="zoom-anim-dialog mfp-hide modal">
  ...
  <div class="modal__btns">
    <button class="modal__btn modal__btn--apply" type="button" onclick="deleteItem('film.html?delete_id=' + item_id, 'films.html')">Xoá</button>
