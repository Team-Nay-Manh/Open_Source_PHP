      ...
      <div class="col-12">
        <div class="main__table-wrap">
          <table class="main__table">
            ...
            <tbody>
              <?php foreach ($user->GetUsers() as $k => $v) { ?>
                <tr>
                  <td>
                    <div class="main__table-text"><?php echo $v['id']; ?></div>
                  </td>
                  <td>
                    <div class="main__table-text"><?php echo $v['full_name']; ?></div>
                  </td>
                  <td>
                    <div class="main__table-text"><?php echo $v['email']; ?></div>
                  </td>
                  <td>
                    <div class="main__table-text"><?php echo $v['phone']; ?></div>
                  </td>
                  <td>
                  ...
                  <td>
                    <div class="main__table-btns">
                      <a href="user.html?id=<?php echo $v['id']; ?>" class="main__table-btn main__table-btn--view">
